...
public class MenuScript : MonoBehaviour
{
	...
	void OnGUI ()
	{
		...
		Rect highscoresRect = new Rect (Screen.width / 2 - buttonWidth / 2, Screen.height / 2 - buttonHeight / 2, buttonWidth, buttonHeight);
		...
		} else if (GUI.Button (highscoresRect, "Highscores")) {
